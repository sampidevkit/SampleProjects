...
FINAL_IMAGE=${DISTDIR}/Simple7SegLED.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ShExtension=.bat
Device=PIC16F877A
ProjectDir="F:\Git\SAMPI\Examples\Ex_MCU8\PIC16F877A\Simple7SegLED.X"
ProjectName=Simple7SegLED
ConfName=default
ImagePath="${DISTDIR}\Simple7SegLED.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}"
ImageDir="${DISTDIR}"
ImageName="Simple7SegLED.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}"
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
IsDebug="true"
else
IsDebug="false"
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/Simple7SegLED.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
	@echo "--------------------------------------"
...
ifeq (2,1) 
	...
	@mv ${OBJECTDIR}/main.cof "${DISTDIR}/Simple7SegLED.X.${IMAGE_TYPE}.cof" 
	@mv ${OBJECTDIR}/main.hex "${DISTDIR}/Simple7SegLED.X.${IMAGE_TYPE}.hex"
else 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/Simple7SegLED.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	${MKDIR} ${DISTDIR} 
ifeq (2,1) 
	
else 
	${MP_LD}   out="${DISTDIR}"  +FM +EX +DF +CC LINK=Simple7SegLED.X.${IMAGE_TYPE}.hex=${OBJECTDIR}/main.o +Y=9 +EA +DF +LN +T +A +M +J +Z -P
...
ifeq (2,1) 
	...
	@"C:/Program Files/Microchip/MPLABX/v6.00/mplab_platform/platform/../mplab_ide/modules/../../bin/hexmate" --edf="C:/Program Files/Microchip/MPLABX/v6.00/mplab_platform/platform/../mplab_ide/modules/../../dat/en_msgs.txt" ${DISTDIR}/Simple7SegLED.X.${IMAGE_TYPE}.hex -o${DISTDIR}/Simple7SegLED.X.${IMAGE_TYPE}.hex
