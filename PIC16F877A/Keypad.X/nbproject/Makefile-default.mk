...
SOURCEFILES_QUOTED_IF_SPACED=src/device_config.c src/interrupt_manager.c src/libcomp.c src/pin_manager.c src/textlcd.c src/keypad.c main.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/src/device_config.p1 ${OBJECTDIR}/src/interrupt_manager.p1 ${OBJECTDIR}/src/libcomp.p1 ${OBJECTDIR}/src/pin_manager.p1 ${OBJECTDIR}/src/textlcd.p1 ${OBJECTDIR}/src/keypad.p1 ${OBJECTDIR}/main.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/src/device_config.p1.d ${OBJECTDIR}/src/interrupt_manager.p1.d ${OBJECTDIR}/src/libcomp.p1.d ${OBJECTDIR}/src/pin_manager.p1.d ${OBJECTDIR}/src/textlcd.p1.d ${OBJECTDIR}/src/keypad.p1.d ${OBJECTDIR}/main.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/src/device_config.p1 ${OBJECTDIR}/src/interrupt_manager.p1 ${OBJECTDIR}/src/libcomp.p1 ${OBJECTDIR}/src/pin_manager.p1 ${OBJECTDIR}/src/textlcd.p1 ${OBJECTDIR}/src/keypad.p1 ${OBJECTDIR}/main.p1

# Source Files
SOURCEFILES=src/device_config.c src/interrupt_manager.c src/libcomp.c src/pin_manager.c src/textlcd.c src/keypad.c main.c
...
ShExtension=.bat
Device=PIC16F877A
ProjectDir="F:\Github\SAMPIDevKit\SampleProjects\PIC16F877A\Keypad.X"
ProjectName=Keypad
ConfName=default
ImagePath="dist\default\${IMAGE_TYPE}\Keypad.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}"
ImageDir="dist\default\${IMAGE_TYPE}"
ImageName="Keypad.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}"
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
IsDebug="true"
else
IsDebug="false"
...
dist/${CND_CONF}/${IMAGE_TYPE}/Keypad.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/Keypad.X.${IMAGE_TYPE}.map  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -O2 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=0 -Wa,-a -msummary=+psect,+class,+mem,+hex,+file  -ginhx32 -Wl,--data-init -mkeep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mdownload -mstackcall -mc90lib -std=c90 -gdwarf-3 -mstack=compiled:auto:auto     $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/Keypad.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	
	@echo Normalizing hex file
	@"C:/Program Files/Microchip/MPLABX/v5.50/mplab_platform/platform/../mplab_ide/modules/../../bin/hexmate" --edf="C:/Program Files/Microchip/MPLABX/v5.50/mplab_platform/platform/../mplab_ide/modules/../../dat/en_msgs.txt" dist/${CND_CONF}/${IMAGE_TYPE}/Keypad.X.${IMAGE_TYPE}.hex -odist/${CND_CONF}/${IMAGE_TYPE}/Keypad.X.${IMAGE_TYPE}.hex
