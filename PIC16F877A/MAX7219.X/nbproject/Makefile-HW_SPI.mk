...
# Source Files
SOURCEFILES=app/libcomp.c mcc_generated_files/pin_manager.c mcc_generated_files/device_config.c mcc_generated_files/spi1.c mcc_generated_files/tmr1.c mcc_generated_files/mcc.c mcc_generated_files/interrupt_manager.c mcc_generated_files/eusart.c XCLibrary/MAX7219.c XCLibrary/TickTimer.c main.c
...
Device=PIC16F877A
ProjectDir="G:\XCRefApps\PIC16F877A\MAX7219.X"
ProjectName=MAX7219
ConfName=HW_SPI
...
${OBJECTDIR}/XCLibrary/MAX7219.p1: XCLibrary/MAX7219.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}/XCLibrary" 
	@${RM} ${OBJECTDIR}/XCLibrary/MAX7219.p1.d 
	@${RM} ${OBJECTDIR}/XCLibrary/MAX7219.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -O1 -fasmfile -maddrqual=ignore -xassembler-with-cpp -I"app" -I"config" -I"XCLibrary" -I"mcc_generated_files" -mwarn=0 -Wa,-a -DXPRJ_HW_SPI=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall -mc90lib $(COMPARISON_BUILD)  -std=c90 -gdwarf-3 -mstack=hybrid:auto:auto     -o ${OBJECTDIR}/XCLibrary/MAX7219.p1 XCLibrary/MAX7219.c 
	@-${MV} ${OBJECTDIR}/XCLibrary/MAX7219.d ${OBJECTDIR}/XCLibrary/MAX7219.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/XCLibrary/MAX7219.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
dist/${CND_CONF}/${IMAGE_TYPE}/MAX7219.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	...
	@"C:/Program Files/Microchip/MPLABX/v5.45/mplab_platform/platform/../mplab_ide/modules/../../bin/hexmate" --edf="C:/Program Files/Microchip/MPLABX/v5.45/mplab_platform/platform/../mplab_ide/modules/../../dat/en_msgs.txt" dist/${CND_CONF}/${IMAGE_TYPE}/MAX7219.X.${IMAGE_TYPE}.hex -odist/${CND_CONF}/${IMAGE_TYPE}/MAX7219.X.${IMAGE_TYPE}.hex
