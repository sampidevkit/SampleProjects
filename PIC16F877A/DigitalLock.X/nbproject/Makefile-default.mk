...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/DigitalLock.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=src/device_config.c src/interrupt_manager.c src/libcomp.c src/pin_manager.c src/pwm1.c src/softpwm.c src/textlcd.c src/tick.c src/tmr0.c src/tmr1.c src/tmr2.c src/tone.c src/keypad.c main.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/src/device_config.p1 ${OBJECTDIR}/src/interrupt_manager.p1 ${OBJECTDIR}/src/libcomp.p1 ${OBJECTDIR}/src/pin_manager.p1 ${OBJECTDIR}/src/pwm1.p1 ${OBJECTDIR}/src/softpwm.p1 ${OBJECTDIR}/src/textlcd.p1 ${OBJECTDIR}/src/tick.p1 ${OBJECTDIR}/src/tmr0.p1 ${OBJECTDIR}/src/tmr1.p1 ${OBJECTDIR}/src/tmr2.p1 ${OBJECTDIR}/src/tone.p1 ${OBJECTDIR}/src/keypad.p1 ${OBJECTDIR}/main.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/src/device_config.p1.d ${OBJECTDIR}/src/interrupt_manager.p1.d ${OBJECTDIR}/src/libcomp.p1.d ${OBJECTDIR}/src/pin_manager.p1.d ${OBJECTDIR}/src/pwm1.p1.d ${OBJECTDIR}/src/softpwm.p1.d ${OBJECTDIR}/src/textlcd.p1.d ${OBJECTDIR}/src/tick.p1.d ${OBJECTDIR}/src/tmr0.p1.d ${OBJECTDIR}/src/tmr1.p1.d ${OBJECTDIR}/src/tmr2.p1.d ${OBJECTDIR}/src/tone.p1.d ${OBJECTDIR}/src/keypad.p1.d ${OBJECTDIR}/main.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/src/device_config.p1 ${OBJECTDIR}/src/interrupt_manager.p1 ${OBJECTDIR}/src/libcomp.p1 ${OBJECTDIR}/src/pin_manager.p1 ${OBJECTDIR}/src/pwm1.p1 ${OBJECTDIR}/src/softpwm.p1 ${OBJECTDIR}/src/textlcd.p1 ${OBJECTDIR}/src/tick.p1 ${OBJECTDIR}/src/tmr0.p1 ${OBJECTDIR}/src/tmr1.p1 ${OBJECTDIR}/src/tmr2.p1 ${OBJECTDIR}/src/tone.p1 ${OBJECTDIR}/src/keypad.p1 ${OBJECTDIR}/main.p1

# Source Files
SOURCEFILES=src/device_config.c src/interrupt_manager.c src/libcomp.c src/pin_manager.c src/pwm1.c src/softpwm.c src/textlcd.c src/tick.c src/tmr0.c src/tmr1.c src/tmr2.c src/tone.c src/keypad.c main.c
...
ShExtension=.bat
Device=PIC16F877A
ProjectDir="F:\Github\SAMPIDevKit\SampleProjects\PIC16F877A\DigitalLock.X"
ProjectName=DigitalLock
ConfName=default
ImagePath="dist\default\${IMAGE_TYPE}\DigitalLock.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}"
ImageDir="dist\default\${IMAGE_TYPE}"
ImageName="DigitalLock.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}"
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
IsDebug="true"
else
IsDebug="false"
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/DigitalLock.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
	@echo "--------------------------------------"
...
${OBJECTDIR}/src/pwm1.p1: src/pwm1.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}/src" 
	@${RM} ${OBJECTDIR}/src/pwm1.p1.d 
	@${RM} ${OBJECTDIR}/src/pwm1.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -O2 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=0 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=+psect,+class,+mem,+hex,+file  -ginhx32 -Wl,--data-init -mkeep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mdownload -mstackcall -mc90lib $(COMPARISON_BUILD)  -std=c90 -gdwarf-3 -mstack=compiled:auto:auto     -o ${OBJECTDIR}/src/pwm1.p1 src/pwm1.c 
	@-${MV} ${OBJECTDIR}/src/pwm1.d ${OBJECTDIR}/src/pwm1.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/src/pwm1.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
${OBJECTDIR}/src/softpwm.p1: src/softpwm.c  nbproject/Makefile-${CND_CONF}.mk 
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -O2 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=0 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=+psect,+class,+mem,+hex,+file  -ginhx32 -Wl,--data-init -mkeep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mdownload -mstackcall -mc90lib $(COMPARISON_BUILD)  -std=c90 -gdwarf-3 -mstack=compiled:auto:auto     -o ${OBJECTDIR}/src/softpwm.p1 src/softpwm.c 
...
${OBJECTDIR}/src/tone.p1: src/tone.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}/src" 
	@${RM} ${OBJECTDIR}/src/tone.p1.d 
	@${RM} ${OBJECTDIR}/src/tone.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -O2 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=0 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=+psect,+class,+mem,+hex,+file  -ginhx32 -Wl,--data-init -mkeep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mdownload -mstackcall -mc90lib $(COMPARISON_BUILD)  -std=c90 -gdwarf-3 -mstack=compiled:auto:auto     -o ${OBJECTDIR}/src/tone.p1 src/tone.c 
	@-${MV} ${OBJECTDIR}/src/tone.d ${OBJECTDIR}/src/tone.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/src/tone.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
	
${OBJECTDIR}/src/keypad.p1: src/keypad.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}/src" 
	@${RM} ${OBJECTDIR}/src/keypad.p1.d 
	@${RM} ${OBJECTDIR}/src/keypad.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -O2 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=0 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=+psect,+class,+mem,+hex,+file  -ginhx32 -Wl,--data-init -mkeep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mdownload -mstackcall -mc90lib $(COMPARISON_BUILD)  -std=c90 -gdwarf-3 -mstack=compiled:auto:auto     -o ${OBJECTDIR}/src/keypad.p1 src/keypad.c 
	@-${MV} ${OBJECTDIR}/src/keypad.d ${OBJECTDIR}/src/keypad.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/src/keypad.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/DigitalLock.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/DigitalLock.X.${IMAGE_TYPE}.map  -D__DEBUG=1  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -O2 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=0 -Wa,-a -msummary=+psect,+class,+mem,+hex,+file  -ginhx32 -Wl,--data-init -mkeep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mdownload -mstackcall -mc90lib -std=c90 -gdwarf-3 -mstack=compiled:auto:auto        $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/DigitalLock.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/DigitalLock.X.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/DigitalLock.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/DigitalLock.X.${IMAGE_TYPE}.map  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -O2 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=0 -Wa,-a -msummary=+psect,+class,+mem,+hex,+file  -ginhx32 -Wl,--data-init -mkeep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mdownload -mstackcall -mc90lib -std=c90 -gdwarf-3 -mstack=compiled:auto:auto     $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/DigitalLock.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	
	@echo Normalizing hex file
	@"C:/Program Files/Microchip/MPLABX/v5.50/mplab_platform/platform/../mplab_ide/modules/../../bin/hexmate" --edf="C:/Program Files/Microchip/MPLABX/v5.50/mplab_platform/platform/../mplab_ide/modules/../../dat/en_msgs.txt" dist/${CND_CONF}/${IMAGE_TYPE}/DigitalLock.X.${IMAGE_TYPE}.hex -odist/${CND_CONF}/${IMAGE_TYPE}/DigitalLock.X.${IMAGE_TYPE}.hex
