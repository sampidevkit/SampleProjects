...
FINAL_IMAGE=${DISTDIR}/MCP9701_CCS.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ImageDir="${DISTDIR}"
ImageName="MCP9701_CCS.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}"
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
IsDebug="true"
else
IsDebug="false"
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/MCP9701_CCS.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
	@echo "--------------------------------------"
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/MCP9701_CCS.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	${MKDIR} ${DISTDIR} 
ifeq (1,1) 
...
ifeq (1,1) 
	...
	@"C:/Program Files/Microchip/MPLABX/v6.00/mplab_platform/platform/../mplab_ide/modules/../../bin/hexmate" --edf="C:/Program Files/Microchip/MPLABX/v6.00/mplab_platform/platform/../mplab_ide/modules/../../dat/en_msgs.txt" ${DISTDIR}/MCP9701_CCS.X.${IMAGE_TYPE}.hex -o${DISTDIR}/MCP9701_CCS.X.${IMAGE_TYPE}.hex
